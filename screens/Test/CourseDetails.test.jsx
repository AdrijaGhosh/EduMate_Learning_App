  ...
  test("renders course details", () => {
    ...
    const { getByText } = render(
      <UserContext.Provider value={mockContext}>
        <CourseDetails route={mockRoute} navigation={mockNavigation} />
      </UserContext.Provider>,
    );

    expect(getByText("React Native Basics")).toBeTruthy();

    expect(getByText("Instructor: John")).toBeTruthy();

    expect(getByText("Category: Mobile Development")).toBeTruthy();

    expect(getByText("Price: $50")).toBeTruthy();
  });
