...
describe("Lesson Screen Tests", () => {
  ...
  test("renders lesson details", () => {
    ...
    const { getByText } = render(
      <Lesson route={mockRoute} navigation={mockNavigation} />,
    );

    expect(getByText("Introduction to React Native")).toBeTruthy();

    expect(getByText("Learn React Native basics")).toBeTruthy();

    expect(getByText("This lesson explains components")).toBeTruthy();
  });
