...
import { View, Text, FlatList, Image, Button, StyleSheet, KeyboardAvoidingView } from 'react-native'
...
const CourseList = ({ navigation }) => {
  ...
  return (
    ...
    <KeyboardAvoidingView style={s.box} behavior="padding" keyboardVerticalOffset={60}>
      <TextInput
      ...
      <View style={s.enrolledSection}>
        ...
        {enrolledCourses.length === 0 ? (
          <Text style={s.emptyText}>You haven't enrolled in any courses yet.</Text>
        ) : (
          <FlatList
